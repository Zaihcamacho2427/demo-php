...
class Cart {
    ...
    private $items = array(); //associative arrray of items in the car. prod_id=> qty, prod_id=> qty, prod_id=> qty
    private $subtotals = array(); //associative array. prod_id=> cost, prod_id=> cost, prod_id=> cost
    private $total_price; //float
    
    function __construct($userid) {
        $this->userid = $userid;
        $this->items = array(); //empty array
        $this->subtotals = array(); //empty array
        $this->total_price = 0;
    }
    ...
    /**
     * @param multitype: $subotals
     */
    public function setSubtotals($subtotals)
    {
        $this->subotals = $subtotals;
    }
